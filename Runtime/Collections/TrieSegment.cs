...
using static Minerva.Localizations.Collections.Trie;
using FirstLayerKeyCollection = Minerva.Localizations.Collections.Trie.FirstLayerKeyCollection;
using KeyCollection = Minerva.Localizations.Collections.Trie.KeyCollection;
using Node = Minerva.Localizations.Collections.Trie.Node;

namespace Minerva.Localizations.Collections
{
