...
namespace Minerva.Localizations.Editor
{
    public class LocalizationEditorSetting : ScriptableObject
    {
        ...
        public void AddMissingKey(string key)
        {
            ...
            Debug.LogWarning($"Key {key} does not appear in the localization file {L10n.Region}. The key will be added to localization manager if this happened in editor.");
            missingKeys.Add(key);
        }
    }
}
